...
model_names <- c("BC", "BC_EstM", "BC_R3")
...
include <- c(1,1,1) 		 # Include these models as part of general outputs (plots and summary/comparison tables)
compare <- c(1,1,0)       	 # Include these models in comparison plots

hessian  <- c(1,1,1) 		 # Which of the listed models have estimation turned on (and a positive definite hessian)?
forecast <- c(1,1,1)		 # Which of the listed models have forecasting turned on? 

show_plots  <- c(0,0,0)		 # Show plots on screen for these models
print_plots <- c(1,1,1)    	 # Print plots to file for these models
